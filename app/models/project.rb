class Project < ActiveRecord::Base
  attr_accessible :name, :beneficiary_name, :address1, :address2, :city, :state,:zip, :description,
      ...
      :actual_start, :planned_end, :actual_end, :created_by, :updated_by,
      :project_type_id, :program_id, :project_subtype_id
  ...
  validates :name, :beneficiary_name, :address1, :city, :state,:zip, :description,
        ...
        :created_by, :project_type_id, :project_subtype_id, :program_id, :presence => true
